...
`)}function h(n){return n.map(l).join(r)}function l(n){return n==null?"":n instanceof Date?je(n):t.test(n+="")?'"'+n.replace(/"/g,'""')+'"':n}return{parse:a,parseRows:o,format:u,formatBody:_,formatRows:g,formatRow:h,formatValue:l}}var Ue=Be(","),Ne=Ue.parse,Pe=w('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p> <p><a href="ui">BitsUI styled components</a></p></section>');function We(r){var t=Pe();d(r,t)}var Oe=w('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function Fe(r){var t=Oe();d(r,t)}var Je=w('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function Le(r){const t=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var e=Je(),a=f(v(e),2);B(a,17,()=>t,U,(o,s)=>{let u=()=>i(s).tag,_=()=>i(s).text;var g=A(),h=S(g);re(h,u,!1,(l,n)=>{var c=Te();z(()=>M(c,_())),d(n,c)}),d(o,g)}),p(e),d(r,e)}var Qe=w("<p> </p>");function Ge(r,t){var e=Qe(),a=v(e);p(e),z(()=>M(a,`I am component A and my favorite number is ${t.number??""}.`)),d(r,e)}var $e=w("<p> </p>");function Ze(r,t){var e=$e(),a=v(e);p(e),z(()=>M(a,`I am component B and my name is ${t.name??""}.`)),d(r,e)}var Ye=w('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function Ve(r){const t={A:Ge,B:Ze},e=[{component:"A",number:42},{component:"B",name:"Russell"}];var a=Ye(),o=f(v(a),2);B(o,17,()=>e,U,(s,u)=>{const _=R(()=>t[i(u).component]);var g=A(),h=S(g);ne(h,()=>i(_),(l,n)=>{n(l,ae(()=>i(u)))}),d(s,g)}),p(a),d(r,a)}var Xe=w('<div><p class="svelte-1sxgmm9"> </p></div>'),Ke=w('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function et(r){let t=P(void 0);var e=Ke(),a=v(e),o=f(v(a)),s=v(o,!0);p(o),p(a);var u=f(a,4);De(u,{get value(){return i(t)},set value(_){j(t,_,!0)},children:(_,g)=>{var h=A(),l=S(h);B(l,16,()=>[0,1,2,3,4],U,(n,c,b)=>{const y=R(()=>i(t)===b);var m=Xe();let x;var k=v(m),T=v(k,!0);p(k),p(m),z(()=>{x=Me(m,1,"step svelte-1sxgmm9",null,x,{active:i(y)}),M(T,c)}),d(n,m)}),d(_,h)},$$slots:{default:!0}}),ke(2),p(e),z(()=>M(s,i(t)||"-")),d(r,e)}const tt=`{
  "hed": "A love story",
  "story": [
    {
      "chart_title": "",
  ...
  "colors": {}
}`;var rt=w("<p></p>"),nt=w('<details><summary></summary> <div class="content"><!></div></details>');function at(r,t){let e=R(()=>typeof t.content=="string"),a=R(()=>t.open==="true");var o=nt(),s=v(o);W(s,()=>t.summary,!0),p(s);var u=f(s,2),_=v(u);{var g=l=>{var n=A(),c=S(n);W(c,()=>t.content),d(l,n)},h=l=>{var n=A(),c=S(n);B(c,17,()=>t.content,U,(b,y)=>{let m=()=>i(y).value;var x=rt();W(x,m,!0),p(x),d(b,x)}),d(l,n)};Y(_,l=>{i(e)?l(g):l(h,-1)})}p(u),p(o),z(()=>{o.open=i(a),ue(o,"name",t.name)}),d(r,o)}var ot=w("<li></li>"),st=w("<ul></ul>");function it(r,t){var e=st();B(e,21,()=>t.li,U,(a,o)=>{var s=ot();W(s,()=>i(o),!0),p(s),d(a,s)}),p(e),d(r,e)}var lt=w("<li></li>"),ht=w("<ol></ol>");function ct(r,t){var e=ht();B(e,21,()=>t.li,U,(a,o)=>{var s=lt();W(s,()=>i(o),!0),p(s),d(a,s)}),p(e),d(r,e)}var dt=w("<p></p>"),pt=w("<section><!></section>");function ut(r,t){V(t,!0);const e={details:at,ul:it,ol:ct};let a=G(t,"components",19,()=>({})),o=G(t,"body",19,()=>[]);var s=A(),u=S(s);B(u,17,o,U,(_,g)=>{let h=()=>i(g).section,l=()=>i(g).content;const n=R(()=>h().toLowerCase().replace(/[^a-z0-9]/g,"")),c=R(()=>a()[h()]);var b=pt(),y=v(b);{var m=k=>{var T=A(),D=S(T);ne(D,()=>i(c),(N,E)=>{E(N,ae(l))}),d(k,T)},x=k=>{var T=A(),D=S(T);B(D,17,l,U,(N,E,O,F)=>{let H=()=>i(E).type,J=()=>i(E).value;const se=R(()=>a()[H()]||e[H()]),ve=R(()=>typeof J()=="string");var ie=A(),_e=S(ie);{var fe=q=>{var I=A(),L=S(I);ne(L,()=>i(se),($,Z)=>{Z($,ae(J))}),d(q,I)},ge=q=>{var I=dt();W(I,J,!0),p(I),d(q,I)},we=q=>{var I=A(),L=S(I);re(L,H,!1,($,Z)=>{var le=A(),be=S(le);W(be,J),d(Z,le)}),d(q,I)},ye=q=>{var I=A(),L=S(I);re(L,H,!1,($,Z)=>{Ae($,()=>({...J()}))}),d(q,I)};Y(_e,q=>{i(se)?q(fe):H()==="text"?q(ge,1):i(ve)?q(we,2):q(ye,-1)})}d(N,ie)}),d(k,T)};Y(y,k=>{i(c)?k(m):k(x,-1)})}p(b),z(()=>ue(b,"id",i(n))),d(_,b)}),d(r,s),X()}var mt=w('<p> </p> <progress max="100"></progress>',1);function vt(r,t){let e=G(t,"label",3,"A"),a=G(t,"value",3,0);var o=mt(),s=S(o),u=v(s,!0);p(s);var _=f(s,2);z(()=>{M(u,e()),ze(_,a())}),d(r,o)}var _t=w('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function ft(r,t){V(t,!0);const{body:e}=qe,a={Test:vt};var o=_t(),s=f(v(o),2),u=v(s),_=v(u,!0);p(u),p(s);var g=f(s,2);ut(g,{get components(){return a},get body(){return e}}),p(o),z(h=>M(_,h),[()=>tt.replace(/\t/g," ")]),d(r,o),X()}const gt=(r,t=pe)=>{var e=wt(),a=v(e),o=v(a,!0);p(a);var s=f(a,2),u=v(s,!0);p(s),p(e),z(()=>{M(o,t().name),M(u,t().age)}),d(r,e)};var wt=w('<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'),yt=w('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',1);function bt(r,t){V(t,!0),G(t,"age",3,30);const e=[{name:"John",age:30},{name:"Jill",age:45}];let a=P(0),o=R(()=>i(a)*2),s=R(()=>i(a)*2),u=P(0);oe(()=>{j(u,i(a)*2)});var _=yt(),g=f(S(_),4),h=f(g,2),l=v(h);p(h);var n=f(h,2),c=v(n);p(n);var b=f(n,2),y=v(b);p(b);var m=f(b,4),x=v(m);Ie(x,()=>t.children??pe),p(m);var k=f(m,4),T=f(k,4);B(T,21,()=>e,U,(D,N)=>{gt(D,()=>i(N))}),p(T),z(()=>{M(l,`${i(a)??""} doubled is ${i(o)??""} (derived)`),M(c,`${i(a)??""} doubled is ${i(s)??""} (derived by)`),M(y,`${i(a)??""} doubled is ${i(u)??""} ($effect)`)}),he("click",g,()=>xe(a)),he("click",k,()=>t.random(Math.floor(Math.random()*10))),d(r,_),X()}Ce(["click"]);const kt=(r,t)=>{let e=P(Se(r)),a=P(null),o=P(!0),s=P(void 0);const u=(h=!0)=>{j(o,h,!0),h===!0&&(j(s,null),j(a,null))},_=async()=>{try{const h=await fetch(i(e),t);if(!h.ok)throw new Error(`Unexpected error occurred (status ${h.status})`);let l;if(i(e).includes(".csv")){const n=await h.text();l=Ne(n)}else l=await h.json();return[null,l]}catch(h){const{errorMessage:l="Unexpected error eccurred"}=h;return[l,null]}},g=async h=>{u(!0);const[l,n]=await _();if(h===i(e)){if(l){u(!1),j(s,l,!0);return}u(!1),j(a,n,!0)}};return oe(()=>{g(i(e))}),{get data(){return i(a)},get loading(){return i(o)},get error(){return i(s)},get url(){return i(e)},set url(h){i(e)!==h&&j(e,h,!0)}}};var xt=w("<p>loading data...</p>"),St=w("<p> </p>"),Tt=w("<p>data loaded</p> <pre> </pre>",1),Ct=w('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Mt(r,t){V(t,!0);const e=`${He}/assets/demo/test.csv`,a=kt(e);oe(()=>{});var o=Ct(),s=f(v(o),2),u=v(s);{var _=l=>{var n=xt();d(l,n)},g=l=>{var n=St(),c=v(n);p(n),z(()=>M(c,`error: ${a.error??""}`)),d(l,n)},h=l=>{var n=Tt(),c=f(S(n),2),b=v(c,!0);p(c),z(y=>M(b,y),[()=>JSON.stringify(a.data,null,2)]),d(l,n)};Y(u,l=>{a.loading?l(_):a.error?l(g,1):l(h,-1)})}p(s),p(o),d(r,o),X()}var At=w('<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function zt(r){let t=P(0);function e(c){console.log(c)}var a=At(),o=f(v(a),2);We(o);var s=f(o,2);Fe(s);var u=f(s,2);Le(u);var _=f(u,2);Ve(_);var g=f(_,2);ft(g,{});var h=f(g,2);Mt(h,{});var l=f(h,2);et(l);var n=f(l,2);bt(n,{random:e,get value(){return i(t)},set value(c){j(t,c,!0)}}),p(a),d(r,a)}function Jt(r){zt(r)}export{Jt as component};
